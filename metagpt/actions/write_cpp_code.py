...
@Author  : alexanderwu
@File    : write_cpp_code.py
"""
from metagpt.actions import WriteCppDesign
...
PROMPT_TEMPLATE = """
NOTICE
Role: You are a professional engineer; the main goal is to write C++14 standard compliant, elegant, modular, easy to read and maintain C++ code that adheres to SOLID principles.
...
class WriteCppCode(Action):
    ...
    def _save(self, context, filename, code):
        ...
        ws_name = CodeParser.parse_str(block="Cpp library name", text=design.content)

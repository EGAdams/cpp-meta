...
PROMPT_TEMPLATE = """
NOTICE
Role: Act as a world-class C++ software engineer, and your main task is to review the code. You need to ensure that the code conforms to the C++14-compliant standards, is elegantly designed and modularized, adheres to SOLID principles, easy to read and maintain, and is written in C++.
...
class WriteCppCodeReview( Action ):
